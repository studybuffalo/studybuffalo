    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient_f', models.CharField(blank=True, max_length=160, null=True)),
        ...
        migrations.CreateModel(
            name='DPD',
            fields=[
                ('drug_code', models.PositiveIntegerField(primary_key=True, serialize=False)),
                ('origin_file', models.CharField(choices=[('a', 'approved'), ('c', 'cancelled'), ('d', 'dormant'), ('m', 'marketed')], max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='DrugProduct',
            fields=[
                ...
                ('drug_product_class', models.CharField(blank=True, help_text='The class field from the data extract', max_length=40, null=True)),
                ...
                ('late_update_date', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pharmaceutical_form_f', models.CharField(blank=True, max_length=40, null=True)),
                ('drug_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hc_dpd.DPD')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('drug_identification_number', models.CharField(max_length=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('package_size_unit', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route_of_administration_f', models.CharField(blank=True, max_length=40, null=True)),
                ('drug_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hc_dpd.DPD')),
            ],
        ),
        migrations.CreateModel(
