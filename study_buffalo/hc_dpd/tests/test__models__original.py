...
def test__active_ingredient__field_order():
    ...
    assert models.OriginalActiveIngredient.field_order == expected_order
...
def test__biosimilar__field_order():
    ...
    assert models.OriginalBiosimilar.field_order == expected_order
...
def test__company__field_order():
    ...
    assert models.OriginalCompany.field_order == expected_order
...
def test__drug_product__field_order():
    ...
    assert models.OriginalDrugProduct.field_order == expected_order
...
def test__form__field_order():
    ...
    assert models.OriginalForm.field_order == expected_order
...
def test__inactive_product__field_order():
    ...
    assert models.OriginalInactiveProduct.field_order == expected_order
...
def test__packaging__field_order():
    ...
    assert models.OriginalPackaging.field_order == expected_order
...
def test__pharmaceutical_standard__field_order():
    ...
    assert models.OriginalPharmaceuticalStandard.field_order == expected_order
...
def test__route__field_order():
    ...
    assert models.OriginalRoute.field_order == expected_order
...
def test__schedule__field_order():
    ...
    assert models.OriginalSchedule.field_order == expected_order
...
def test__status__field_order():
    ...
    assert models.OriginalStatus.field_order == expected_order
...
def test__therapeutic_class__field_order():
    ...
    assert models.OriginalTherapeuticClass.field_order == expected_order
...
def test__veterinary_species__field_order():
    ...
    assert models.OriginalVeterinarySpecies.field_order == expected_order
