...
class CardSerializer(serializers.ModelSerializer):
    question_parts = QuestionPartSerializer(
        many=True,
    )
    tags = TagSerializer(
        many=True,
    ...
    class Meta:
        model = models.Card
        fields = (
            'id', 'question_parts', 'reviewed', 'active', 'date_modified',
    ...
    def get_or_create_tag(self, validated_data):
        ...
        for tag in tag_data:
            retrieved, created = models.Tag.objects.get_or_create(
    ...
    def create(self, validated_data):
        ...
        # Assign the card to the specified decks
