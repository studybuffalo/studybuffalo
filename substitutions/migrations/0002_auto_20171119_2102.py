# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-11-20 04:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='apps',
            name='model_sub',
            field=models.CharField(help_text='The model name where the verified substitutions should be added to', max_length=50),
        ),
        migrations.AlterField(
            model_name='modelfields',
            name='dictionary_check',
            field=models.BooleanField(default=False, help_text='Whether to add a online search button to confirm spelling'),
        ),
        migrations.AlterField(
            model_name='modelfields',
            name='field_name',
